...
//                       child: Row(children: [
//                         Icon(Icons.location_on, size: 25, color: Theme
//                             .of(context)
//                             .primaryColor),
//                         SizedBox(width: 5),
...
//                         Expanded(
//                           child: Text(
//                             '${addressCubit.pickPlaceMark.name ??
//                                 ''} ${addressCubit.pickPlaceMark.locality ??
//                                 ''} '
//                                 '${addressCubit.pickPlaceMark.postalCode ??
//                                 ''} ${addressCubit.pickPlaceMark.country ??
//                                 ''}',
...
//                         ),
//                         SizedBox(width: 10),
//                         Icon(Icons.search, size: 25, color: Theme
//                             .of(context)
//                             .textTheme
//                             .bodyText1!
//                             .color),
